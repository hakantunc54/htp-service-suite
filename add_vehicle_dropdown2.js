...
const target = '<label className="block text-xs font-semibold text-gray-500 uppercase mb-1">WE-Lage</label>';
const replace = `<label className="block text-xs font-semibold text-gray-500 uppercase mb-1">Fahrzeug / Techniker</label>
                  <select 
                    value={vehicle}
                    onChange={e => setVehicle(e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 outline-none text-sm bg-white mb-4"
                  >
...
console.log("Added vehicle dropdown 2");
