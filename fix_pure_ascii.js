          ...
          <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div className="p-6 overflow-y-auto">
              <p className="text-sm text-gray-600 mb-4">
                ...
                Bitte markiere den Text unten (oder dr\\u00fccke <strong>Strg + A</strong> und <strong>Strg + C</strong>) und \\u00f6ffne dann Google Messages.
              </p>
              <textarea 
...
// We parse the string to evaluate the unicode escapes BEFORE replacing, so the actual file gets the real unicode chars.
const parsedNewUi = JSON.parse('"' + newUi.replace(/"/g, '\\"') + '"');

code = code.replace(regex, parsedNewUi);
fs.writeFileSync('src/app/orders/[id]/page.tsx', code, 'utf8');
console.log("Replaced using pure ascii script");
