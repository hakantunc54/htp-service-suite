...
// It should end right before `<EditServicesModal`
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div className="p-6 overflow-y-auto">
              ...
              <div className="mb-6">
                <label className="block text-xs font-bold text-gray-500 uppercase mb-2">2. Vorlage ausw\\u00e4hlen</label>
              ...
              {manualSmsText && (
                <div className="mb-4">
                  ...
                  <textarea 
                    ...
                    onFocus={(e) => e.target.select()}
                  />
                  <p className="text-xs text-gray-500 mt-2">Text anklicken und Strg+C dr\\u00fccken.</p>
                </div>
              )}
            </div>
...
const parsedNewUi = JSON.parse('"' + newModal.replace(/"/g, '\\"') + '"');

code = code.substring(0, startIdx) + parsedNewUi + code.substring(endIdx);
