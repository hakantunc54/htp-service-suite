...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var templates, _i, templates_1, t, serviceItems, _a, serviceItems_1, item;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    t = templates_1[_i];
                    return [4 /*yield*/, prisma.smsTemplate.upsert({
                            where: { name: t.name },
                            update: {},
                            create: t,
                        })];
                ...
                case 4:
                    ...
                    _a = 0, serviceItems_1 = serviceItems;
                    _b.label = 5;
                case 5:
                    if (!(_a < serviceItems_1.length)) return [3 /*break*/, 8];
                    item = serviceItems_1[_a];
                    return [4 /*yield*/, prisma.serviceItem.upsert({
